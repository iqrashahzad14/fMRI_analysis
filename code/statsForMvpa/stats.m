...
%
[h1,p1]=ttest2(anat_lS1,ext_lS1);
[h2,p2]=ttest2(anat_lPC,ext_lPC);
[h3,p3]=ttest2(anat_lPC,ext_rPC);
[h4,p4]=ttest2(anat_lPC,ext_lMTt);
[h5,p5]=ttest2(anat_lPC,ext_rMTt);
[h6,p6]=ttest2(anat_lPC,ext_lhMT);
[h7,p7]=ttest2(anat_lPC,ext_rhMT);
