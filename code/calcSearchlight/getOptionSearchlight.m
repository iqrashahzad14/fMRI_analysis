...
function opt = getOptionSearchlight()
  ...
  opt.pathOutput = fullfile(fileparts(mfilename('fullpath')),'..', '..','outputs','derivatives',...
      'searchlightOutput','searchlightResults');
  opt.searchlightSmooth = fullfile(fileparts(mfilename('fullpath')),'..', '..','outputs','derivatives',...
      'searchlightOutput','searchlightResultsSmooth');
