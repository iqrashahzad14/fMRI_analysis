...
model_series = [mean(handDownDir_lhMT),mean(handUpDir_lhMT); ...
                mean(handDownDir_rhMT), mean(handUpDir_rhMT);...
     mean(handDownDir_lS1),mean(handUpDir_lS1); ...
     mean(handDownDir_lPC),mean(handUpDir_lPC); ...
     mean(handDownDir_rPC), mean(handUpDir_rPC);...
     mean(handDownDir_lMTt),mean(handUpDir_lMTt); ...
     mean(handDownDir_rMTt),mean(handUpDir_rMTt)];

model_error = [std(handDownDir_lhMT)/sqrt(length(subList)),std(handUpDir_lhMT)/sqrt(length(subList));...
     std(handDownDir_rhMT)/sqrt(length(subList)), std(handUpDir_rhMT)/sqrt(length(subList));...
     std(handDownDir_lS1)/sqrt(length(subList)),std(handUpDir_lS1)/sqrt(length(subList)); ...
   std(handDownDir_lPC)/sqrt(length(subList)),std(handUpDir_lPC)/sqrt(length(subList));...
    std(handDownDir_rPC)/sqrt(length(subList)), std(handUpDir_rPC)/sqrt(length(subList));...
     std(handDownDir_lMTt)/sqrt(length(subList)),std(handUpDir_lMTt)/sqrt(length(subList));...
    std(handDownDir_rMTt)/sqrt(length(subList)),std(handUpDir_rMTt)/sqrt(length(subList))];
...
scatter(repmat(x(1,4), length(handDownDir_lPC), 1),handDownDir_lPC,sz,'MarkerEdgeColor',darkGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);
scatter(repmat(x(2,4), length(handUpDir_lPC), 1),handUpDir_lPC,sz,'MarkerEdgeColor',lightGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);

scatter(repmat(x(1,5), length(handDownDir_rPC), 1),handDownDir_rPC,sz,'MarkerEdgeColor',darkGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);
scatter(repmat(x(2,5), length(handUpDir_rPC), 1),handUpDir_rPC,sz,'MarkerEdgeColor',lightGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);
