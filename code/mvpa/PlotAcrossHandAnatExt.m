...
scatter(repmat(x(1,2), length(anat_lPC), 1),anat_lPC,sz,'MarkerEdgeColor',darkGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);
scatter(repmat(x(2,2), length(ext_lPC), 1),ext_lPC,sz,'MarkerEdgeColor',lightGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);

scatter(repmat(x(1,3), length(anat_rPC), 1),anat_rPC,sz,'MarkerEdgeColor',darkGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);
scatter(repmat(x(2,3), length(ext_rPC), 1),ext_rPC,sz,'MarkerEdgeColor',lightGreen,'MarkerFaceColor','w','LineWidth',LineWidthMarkers);
